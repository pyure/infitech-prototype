...
alloy_smelter.recipeBuilder().inputs([<ore:crushedRedstone> * 2, pRedstone * pollenIn]).outputs(<ore:pollinatedOreRedstone>.firstItem * 4).duration(60).EUt(30).buildAndRegister();
